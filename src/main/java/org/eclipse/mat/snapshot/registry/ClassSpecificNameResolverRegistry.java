...
public final class ClassSpecificNameResolverRegistry
{
    ...
    static {
    	instance.registry.registerResolver(new org.eclipse.mat.inspections.CommonNameResolver.StringResolver());
    	instance.registry.registerResolver(new org.eclipse.mat.inspections.CommonNameResolver.StringBufferResolver());
    	instance.registry.registerResolver(new org.eclipse.mat.inspections.CommonNameResolver.ThreadResolver());
    	instance.registry.registerResolver(new org.eclipse.mat.inspections.CommonNameResolver.ThreadGroupResolver());
    	instance.registry.registerResolver(new org.eclipse.mat.inspections.CommonNameResolver.ValueResolver());
    	instance.registry.registerResolver(new org.eclipse.mat.inspections.CommonNameResolver.CharArrayResolver());
    	instance.registry.registerResolver(new org.eclipse.mat.inspections.CommonNameResolver.ByteArrayResolver());
    	instance.registry.registerResolver(new org.eclipse.mat.inspections.CommonNameResolver.URLResolver());
    	instance.registry.registerResolver(new org.eclipse.mat.inspections.CommonNameResolver.AccessibleObjectResolver());
    	instance.registry.registerResolver(new org.eclipse.mat.inspections.CommonNameResolver.FieldResolver());
    	instance.registry.registerResolver(new org.eclipse.mat.inspections.CommonNameResolver.MethodResolver());
    	instance.registry.registerResolver(new org.eclipse.mat.inspections.CommonNameResolver.ConstructorResolver());
